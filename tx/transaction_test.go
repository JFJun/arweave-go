...
func TestNewTransactionNew(t *testing.T) {
	sig := "ECVoUeBiN3B_WkQY24LF29NlyNAnrBrlat_Z87dOd9Fpo6E2aQxNGUY88XVCeY9TCiAZ9sLLhlIx1ZQr9SLqqp9az-AB0gYo7FhCq4EwyJ5DM-ddncccPPycvpWhFNJ9AIfGlaLwH2P2AsoeWVFo6AX5EVk_toyQAlnMlpc2TCs1d14NaLuzV1GUX8PLIWV-GkQA-R36x1r9YjdqJPu_-YoOXF1HBJli6XhK-ddAqIVH--ds6CKmQiDlUkCTZfTVK56GDUUtQSkuus3PBhN7ixFg_bMXd6KIV-m1MOJ74kgd9elHLf1PAqmS-w_ic095ewhaGC4NVbGX2GJWQSVNRIiq3gO8hkwJcpJjUCdDeAcX9d2D1M2kip6BP--a-xeVzMqSb3NdTva3nujKilOnYJqq6vtaKqBDQsuVbBYpQ3WDg-qsKze9X3r55lmYnp9cFYPW9ydWxfzNm1Pad5y3J14VTrkJWe8ppNVpJyN_hGU0ksFzAWTOVGa2Fpyj8UfSS73Zyt8OPYZ9AcbPGttvlcIqWlB8W9kno1ceJT60o0LzTGnk49M8nV04fAEGKsSl3IuVn_wWuqIAXbY-tKrZ14wLvLI4GLsvJn3rSiFM2Nuua2XM2qwbhkCbcfZCx6EjjH9uKqqb9W8xfTNPuOGNErsEwqyBAmDDuNoB383a1t0"
	data, err := utils.DecodeString(sig)
	if err != nil {
		panic(err)
	}
	h := sha256.Sum256(data)
	fmt.Println(utils.EncodeToBase64(h[:]))
}
